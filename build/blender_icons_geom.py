...
def mesh_data_lists_from_mesh(me, material_colors):
    ...
    for p in me_polys:
        # All faces are handled.
        # Backfacing/zero area is checked just before writing.
...
def write_mesh_to_py(fh, ob, ob_children):
    ...
    # 100 levels of Z depth.
    # Round to avoid differences from precision errors.
    ...
    # Pixel size needs to be increased.
    # A pixel needs one extra geom coordinate.
...
def create_argparse():
    ...
    parser.add_argument(
        "--output-dir",
        dest="output_dir",
        default="Q:/Proj/PyDev/CursorPanel/build/output",
        type=str,
        metavar="DIR",
        required=False,
